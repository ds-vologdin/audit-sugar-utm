...
urlpatterns = [
    ...
    url(r'^utmpays/last/(?P<last>\w+)/$',
        cache_page(60 * 30)(views.utmpays_statistic)),
    ...
    url(r'^tickets/bad_fill/last/',
        include([url(r'^(?P<last>\w+)/$',
                 ...
                 url(r'^(?P<last>\w+)/csv/$',
                     ...
                     {'csv_flag': True}), ])),
    # ex. /audit/repairs/
    url(r'^repairs/$', cache_page(60 * 15)(views.repairs_dublicate),
        {'last': 'month'}),
    # ex. /audit/repairs/last/...
    url(r'^repairs/last/',
        include([url(r'^(?P<last>\w+)/$',
                cache_page(60 * 5)(views.repairs_stat),), ])),
    # ex. /audit/repairs/2018/
    url(r'^repairs/(?P<year>[0-9]{4})/$',
        cache_page(60 * 15)(views.repairs_stat)),
    ...
    url(r'^tickets/top_no_service/(?P<year>[0-9]{4})/(?P<month>[0-9]{2})/csv/$',
        cache_page(60 * 15)(views.top_no_service), {'csv_flag': True}),
    ...
    url(r'^tickets/mass/last/(?P<last>\w+)/$',
        cache_page(60 * 5)(views.tickets_mass)),
    # ex. /audit/tickets/mass/2018/
    url(r'^tickets/mass/(?P<year>[0-9]{4})/$',
        cache_page(60 * 15)(views.tickets_mass)),
    ...
    url(r'^survey/last/(?P<last>\w+)/$',
        cache_page(60 * 5)(views.survey_report)),
    # ex. /audit/survey/2018/
    url(r'^survey/(?P<year>[0-9]{4})/$',
        cache_page(60 * 15)(views.survey_report)),
    ...
    url(r'^connections/last/(?P<last>\w+)/$',
        cache_page(60 * 5)(views.connections_report)),
    # ex. /audit/connections/2018/
    url(r'^connections/(?P<year>[0-9]{4})/$',
        cache_page(60 * 15)(views.connections_report)),
    ...
    url(r'^support/last/(?P<last>\w+)/$',
        cache_page(60 * 15)(views.support_report)),
    ...
    url(r'^acc_question/last/(?P<last>\w+)/$',
        cache_page(60 * 15)(views.acc_question_stat)),
